...
#include "ui_QButtonGroupCheckbox.h"

class QButtonGroupCheckbox : public QWidget
{
	Q_OBJECT

public:
	QButtonGroupCheckbox(QWidget *parent = Q_NULLPTR);
public slots:
	void GClick(QAbstractButton *but);
	void GToggle(QAbstractButton *but, bool check);
private:
	Ui::QButtonGroupCheckboxClass ui;
};
